...
class Action_Generic(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        try:
            ...
            if 'location' in entities:  # Identificado un municipio -> entidades de ese municipio del MC
                ...
                if idLocation != '':
                    temas_by_muncicipio = getSubjectByIdMunicipio(idLocation)
                if temas_by_muncicipio is not None:
                    for result in temas_by_muncicipio:
    ...
    def get_intent_names(self, tracker):
        ...
        is_intent_name_list = '_list' in intent_ranking[0]['name']  # solo sugiere las del mismo marco tourims.grastronomy
